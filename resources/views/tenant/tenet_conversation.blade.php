        ...
        <div id="sidebar-nav" style="background-color: black;">
            ...
            <ul>
                @if (Illuminate\Support\Facades\Auth::user()->role_id_fk == 2)
                    ...
                    <li><a href="{{ route('con', [Illuminate\Support\Facades\Auth::id()]) }}"><i
                ...
                @elseif(Illuminate\Support\Facades\Auth::user()->role_id_fk == 3)
                    <li class="active"><a href="{{ route('advisor_dashboard') }}"><i class="fa fa-dashboard"></i>
                            Dashboard</a></li>
    ...
    <section id="content">
        <div id="header">
            <div class="header-nav" style="background-color: black;">
                ...
                <div class="nav">
                    <ul>
                        @if (Illuminate\Support\Facades\Auth::user()->role_id_fk == 'tenant')
                            <li class="nav-mail">
                                @php
