<div class="modal fade" id="editTenantModal" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
                ...
                <div class="card card-plain">
                    ...
                    <div class="card-body pb-3">
                        ...
                        <div class="row">
                            ...
                            <label>Address</label>
                            <div class="input-group mb-3">
                                {!! Form::text('address',$user->tenants->address,array('class' => 'form-control')) !!}
                            </div>
                            <label>Email</label>
                            <div class="input-group mb-3">
