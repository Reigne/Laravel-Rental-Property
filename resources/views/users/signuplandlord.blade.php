                ...
                <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
                    <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                        ...
                        @endif
                            ...
                            <div class="card-body">
                              <form role="form text-left" method="POST" action="{{ route('reglandlord') }}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                          <input type="text" class="form-control" id="phone" name="phone"
                                            placeholder="Phone number" aria-label="phone" value="{{old('phone')}}">
                                    </div>
                                     <div class="mb-3">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Signup</button>
                                    </div>
